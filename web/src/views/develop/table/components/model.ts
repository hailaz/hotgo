...
export const presetMeta: PresetMeta[] = [
  ...
  },
  {
    key: '删除标记',
    label: '软删除',
    description: '软删除标记，GoFrame 约定字段',
  ...
  },
  {
    key: '状态字段',
    label: '状态',
    description: '通用状态标识，1=正常 2=禁用等',
    fields: 'status (tinyint)',
    tag: '常用',
  },
  {
    key: '排序字段',
    label: '排序',
    description: '列表排序权重，值越小越靠前',
    fields: 'sort (int)',
    tag: '常用',
  },
  {
    key: '备注字段',
    label: '备注',
    description: '通用备注信息，出现在17张表中',
    fields: 'remark (varchar 255)',
    tag: '常用',
  },
  {
    key: '名称字段',
    label: '名称',
    description: '通用名称，出现在13张表中',
  ...
  },
  {
    ...
    label: '描述',
    description: '简短描述信息',
    fields: 'description (varchar 255)',
    tag: '常用',
  },
  {
    key: '操作人字段',
    label: '操作人',
    description: '记录创建者和更新者的用户ID',
    fields: 'created_by, updated_by (bigint)',
    tag: '审计',
  },
  {
    key: '管理员ID',
  ...
  },
  {
    ...
    label: '分类ID',
    description: '关联分类表',
    fields: 'category_id (bigint)',
    tag: '关联',
  },
  {
    key: '树形关系字段',
    label: '树形关系',
    description: '父子层级关系，适用于菜单/分类等',
    fields: 'pid, level, tree',
    tag: '结构',
  },
  {
    key: '内容字段',
    label: '富文本内容',
    description: '长文本内容，如文章正文、详情等',
  ...
  },
  {
    key: '图片字段',
    label: '图片',
    description: '单图 + 多图，支持JSON存储',
    fields: 'image (varchar), images (json)',
    tag: '媒体',
  },
  {
    key: '附件字段',
    label: '附件',
    description: '单附件 + 多附件',
    fields: 'attachfile (varchar), attachfiles (json)',
    tag: '媒体',
  },
  {
    key: '头像字段',
    label: '头像',
    description: '用户/管理员头像',
    fields: 'avatar (varchar 255)',
    tag: '用户',
  },
  {
    key: '性别字段',
    label: '性别',
    description: '1=男 2=女 等',
    fields: 'sex (tinyint)',
    tag: '用户',
  },
  {
    ...
    label: '联系方式',
    description: '邮箱和手机号',
    fields: 'email (varchar), mobile (varchar)',
    tag: '用户',
  },
  {
    key: '金额字段',
    label: '金额',
    description: '高精度金额，两位小数',
    fields: 'money (decimal 10,2)',
    tag: '业务',
  },
  {
    key: '价格字段',
  ...
  },
  {
    ...
    label: '订单号',
    description: '业务订单编号',
    fields: 'order_sn (varchar 64)',
    tag: '业务',
  },
  {
    key: '开关字段',
    label: '开关',
    description: '布尔开关 0/1',
    fields: 'switch (tinyint)',
    tag: '业务',
  },
  {
    key: '时间范围字段',
    label: '时间范围',
    description: '开始-结束时间区间',
    fields: 'start_at, end_at (datetime)',
    tag: '业务',
  },
  {
    key: 'IP地址',
    label: 'IP地址',
    description: '记录客户端IP',
    fields: 'ip (varchar 128)',
    tag: '日志',
  },
  {
    key: '浏览次数',
    label: '浏览次数',
    description: '内容浏览/点击计数',
    fields: 'views (bigint)',
    tag: '统计',
  },
  {
